				...
				<div className='max-w-md w-full p-4 bg-white rounded-lg'>
					<div className='space-y-4 text-center'>
						...
						<p className='text-gray-600'>
							Enter a Slack URL to convert between N High School and N Junior High.
						</p>
						<input
							type='text'
							value={url}
							onChange={(e: Event) => setUrl((e.currentTarget as HTMLInputElement).value)}
							placeholder='Enter Slack URL'
							className='w-full p-2 border border-gray-300 rounded-lg'
						/>
						<button onClick={replaceUrl} className='w-full bg-blue-500 text-white p-2 rounded-lg'>
							Convert URL
						</button>
						{convertedUrl && (
